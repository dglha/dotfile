...
# for a blank page.
# Type: FuzzyUrl
c.url.default_page = 'google.com.vn'
...
c.url.start_pages = 'google.com.vn'
...
# Type: Font
c.fonts.monospace = '"xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Terminal'
...
# Type: Font
c.fonts.completion.category = 'bold 9pt lucy tewi '
...
# Type: Font
c.fonts.hints = 'bold 9pt lucy tewi '
